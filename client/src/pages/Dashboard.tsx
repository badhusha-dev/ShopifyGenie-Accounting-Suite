    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Welcome to your ShopifyGenie Accounting Suite dashboard
        </p>
      </div>
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            New order processed: <span className="font-medium text-gray-900">#ORD-001</span>
                          </p>
                        </div>
                  ...
                  <div className="relative">
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            New customer registered: <span className="font-medium text-gray-900">john@example.com</span>
                          </p>
                        </div>
                        <div className="text-right text-sm whitespace-nowrap text-gray-500">
